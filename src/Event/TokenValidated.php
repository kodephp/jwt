...
class TokenValidated
{
    ...
    {
        return $this->validatedAt->setTimestamp($this->payload->iat);
    }
    ...
    {
        return $this->validatedAt->setTimestamp($this->payload->exp);
    }
    ...
    public function getNotBefore(): ?\DateTimeImmutable
    {
        if (isset($this->payload->nbf)) {
            return $this->validatedAt->setTimestamp($this->payload->nbf);
        }
